...
#ifndef MBED_OS_STM32IPV2ETHDESCRIPTORS_H
#define MBED_OS_STM32IPV2ETHDESCRIPTORS_H
...
// Union of all possible descriptor formats.
// Note that per the datasheet, Tx descriptors must be word aligned.
union alignas(uint32_t) EthTxDescriptor {
    EthTxDescriptorToDMAFmt toDMAFmt;
    EthTxDescriptorFromDMAFmt fromDMAFmt;
};
...
#endif
#endif //MBED_OS_STM32IPV2ETHDESCRIPTORS_H
