...
/* generated vector source file - do not edit */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_NUM_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [27] = mbed_sci_rxi_isr, /* SCI0 RXI (Receive data full) */
            [28] = mbed_sci_txi_isr, /* SCI0 TXI (Transmit data empty) */
            [29] = NULL,
            [30] = mbed_sci_eri_isr, /* SCI0 ERI (Receive error) */
            [31] = mbed_sci_rxi_isr, /* SCI1 RXI (Receive data full) */
            [32] = mbed_sci_txi_isr, /* SCI1 TXI (Transmit data empty) */
            [33] = NULL,
            [34] = mbed_sci_eri_isr, /* SCI1 ERI (Receive error) */
            [35] = mbed_sci_rxi_isr, /* SCI2 RXI (Receive data full) */
            [36] = mbed_sci_txi_isr, /* SCI2 TXI (Transmit data empty) */
            [37] = NULL,
            [38] = mbed_sci_eri_isr, /* SCI2 ERI (Receive error) */
            [39] = mbed_sci_rxi_isr, /* SCI3 RXI (Receive data full) */
            [40] = mbed_sci_txi_isr, /* SCI3 TXI (Transmit data empty) */
            [41] = NULL,
            [42] = mbed_sci_eri_isr, /* SCI3 ERI (Receive error) */
            [43] = mbed_sci_rxi_isr, /* SCI4 RXI (Receive data full) */
            [44] = mbed_sci_txi_isr, /* SCI4 TXI (Transmit data empty) */
            [45] = NULL,
            [46] = mbed_sci_eri_isr, /* SCI4 ERI (Receive error) */
            [47] = mbed_sci_rxi_isr, /* SCI9 RXI (Receive data full) */
            [48] = mbed_sci_txi_isr, /* SCI9 TXI (Transmit data empty) */
            [49] = NULL,
            [50] = mbed_sci_eri_isr, /* SCI9 ERI (Receive error) */
