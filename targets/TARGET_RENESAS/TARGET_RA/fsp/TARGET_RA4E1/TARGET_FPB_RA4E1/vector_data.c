...
/* generated vector source file - do not edit */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_NUM_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [26] = mbed_sci_rxi_isr, /* SCI3 RXI (Receive data full) */
            [27] = mbed_sci_txi_isr, /* SCI3 TXI (Transmit data empty) */
            [28] = NULL,
            [29] = mbed_sci_eri_isr, /* SCI3 ERI (Receive error) */
            [30] = mbed_sci_rxi_isr, /* SCI4 RXI (Receive data full) */
            [31] = mbed_sci_txi_isr, /* SCI4 TXI (Transmit data empty) */
            [32] = NULL,
            [33] = mbed_sci_eri_isr, /* SCI4 ERI (Receive error) */
            [34] = mbed_sci_rxi_isr, /* SCI9 RXI (Receive data full) */
            [35] = mbed_sci_txi_isr, /* SCI9 TXI (Transmit data empty) */
            [36] = NULL,
            [37] = mbed_sci_eri_isr, /* SCI9 ERI (Receive error) */
