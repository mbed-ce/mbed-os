...
class TestBoards(TestCase):
    ...
    def test_iteration_is_repeatable(self, mocked_get_board_data):
        ...
        boards = Boards.from_offline_database()
    ...
    def test_len_boards(self, mocked_get_board_data):
        ...
        self.assertEqual(len(Boards.from_offline_database()), len(board_data))
    ...
    def test_get_board_success(self, mocked_get_board_data):
        ...
        boards = [Board.from_online_board_entry(b) for b in fake_board_data]
        filtered_board_data = [asdict(board) for board in boards]

        mocked_get_board_data.return_value = filtered_board_data
    ...
    def test_json_dump_from_raw_and_filtered_data(self, mocked_get_board_data):
        raw_board_data = [
